...
import com.nimeshpatel.weatherforcast.screens.favourite.FavouriteViewModel
...
fun WeatherAppBar(
    ...
    CenterAlignedTopAppBar(
        ...
        navigationIcon = {
            ...
            if (isMainScreen) {
                val isAlreadyFavouriteList =
                    favouriteViewModel.favouriteHistoryList.collectAsState().value.filter { item ->
                        (item.city == title.split(",").first())
                    }

                if (isAlreadyFavouriteList.isNullOrEmpty()) {
                    Icon(
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                favouriteViewModel
                                    .insertFavourite(
                                        Favourite(
                                            city = dataList.getOrNull(0) ?: "",
                                            country = dataList.getOrNull(1) ?: ""
                                        )
                                    )
                                    .run {
                                        Toast
...
fun ShowSettingDropDownMenu(showDialog: MutableState<Boolean>, navController: NavController) {
    ...
    Column(
        ...
        DropdownMenu(
            ...
            items.forEachIndexed { _, itemName ->
